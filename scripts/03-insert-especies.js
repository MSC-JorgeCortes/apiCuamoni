    ...
    cuidadosPorEdad: [
      {
        ...
        riego: { cantidadAgua: "200-300ml", frecuencia: "Cada 2 días", observaciones: "Mantener suelo húmedo pero no encharcado" },
        fertilizacion: { tipoFertilizante: "Compost orgánico", cantidad: "100g", frecuencia: "Mensual", epocaAplicacion: "Todo el año" },
        poda: { requiere: false },
    ...
    cuidadosPorEdad: [
      {
        ...
        riego: { cantidadAgua: "150-250ml", frecuencia: "Cada 3 días", observaciones: "Evitar encharcamientos" },
        fertilizacion: { tipoFertilizante: "Humus de lombriz", cantidad: "150g", frecuencia: "Bimestral", epocaAplicacion: "Época de crecimiento" },
        poda: { requiere: false },
    ...
    cuidadosPorEdad: [
      {
        ...
        fertilizacion: { tipoFertilizante: "Fosfato diamónico", cantidad: "300g", frecuencia: "Trimestral", epocaAplicacion: "Época de lluvias" },
        poda: { requiere: true, tipo: "Formación", frecuencia: "Anual", epocaRecomendada: ["Secas"] },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "200-400ml", "frecuencia": "Cada 3 días", "observaciones": "Tolerante a sequía una vez establecido" },
        "fertilizacion": { "tipoFertilizante": "Compost", "cantidad": "150g", "frecuencia": "Bimestral", "epocaAplicacion": "Primavera-Verano" },
        "poda": { "requiere": false },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Bolsa negra" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "400-600ml", "frecuencia": "Cada 4 días", "observaciones": "Sensible al exceso de agua" },
        "fertilizacion": { "tipoFertilizante": "Balanceado", "cantidad": "250g", "frecuencia": "Trimestral", "epocaAplicacion": "Lluvias" },
        "poda": { "requiere": false },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "300-500ml", "frecuencia": "Cada 3 días", "observaciones": "Requiere riego regular en primeros años" },
        "fertilizacion": { "tipoFertilizante": "Fosfórico", "cantidad": "200g", "frecuencia": "Trimestral", "epocaAplicacion": "Lluvias" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "200-300ml", "frecuencia": "Cada 5 días", "observaciones": "Muy resistente a sequía" },
        "fertilizacion": { "tipoFertilizante": "Poco exigente", "cantidad": "100g", "frecuencia": "Semestral", "epocaAplicacion": "Lluvias" },
        "poda": { "requiere": false },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Bolsa negra" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "200-350ml", "frecuencia": "Cada 3 días", "observaciones": "Adaptable a diferentes condiciones" },
        "fertilizacion": { "tipoFertilizante": "Orgánico", "cantidad": "150g", "frecuencia": "Bimestral", "epocaAplicacion": "Todo el año" },
        "poda": { "requiere": true, "tipo": "Formación" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Bolsa negra" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "300-500ml", "frecuencia": "Cada 3 días", "observaciones": "Sensible a encharcamientos" },
        "fertilizacion": { "tipoFertilizante": "Balanceado", "cantidad": "200g", "frecuencia": "Trimestral", "epocaAplicacion": "Lluvias" },
        "poda": { "requiere": true, "tipo": "Formación" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Contenedor grande" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "400-600ml", "frecuencia": "Cada 3 días", "observaciones": "Requiere humedad constante" },
        "fertilizacion": { "tipoFertilizante": "Rico en fósforo", "cantidad": "300g", "frecuencia": "Trimestral", "epocaAplicacion": "Lluvias" },
        "poda": { "requiere": true, "tipo": "Formación" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Contenedor grande" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "500-700ml", "frecuencia": "Cada 2 días", "observaciones": "Requiere alta humedad" },
        "fertilizacion": { "tipoFertilizante": "Orgánico", "cantidad": "400g", "frecuencia": "Bimestral", "epocaAplicacion": "Todo el año" },
        "poda": { "requiere": true, "tipo": "Contención" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Contenedor grande" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "200-300ml", "frecuencia": "Cada 4 días", "observaciones": "Muy adaptable" },
        "fertilizacion": { "tipoFertilizante": "Poco exigente", "cantidad": "100g", "frecuencia": "Semestral", "epocaAplicacion": "Lluvias" },
        "poda": { "requiere": true, "tipo": "Frecuente" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Bolsa negra" },
        "protecciones": ["Resistente naturalmente"]
      }
    ],
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "250-400ml", "frecuencia": "Cada 5 días", "observaciones": "Muy resistente a sequía" },
        "fertilizacion": { "tipoFertilizante": "Poco exigente", "cantidad": "150g", "frecuencia": "Semestral", "epocaAplicacion": "Lluvias" },
        "poda": { "requiere": true, "tipo": "Formación" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Bolsa negra" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "300-450ml", "frecuencia": "Cada 3 días", "observaciones": "Riego regular para buena floración" },
        "fertilizacion": { "tipoFertilizante": "Rico en fósforo", "cantidad": "200g", "frecuencia": "Trimestral", "epocaAplicacion": "Floración" },
        "poda": { "requiere": true, "tipo": "Formación" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "300-500ml", "frecuencia": "Cada 3 días", "observaciones": "Riego regular en crecimiento" },
        "fertilizacion": { "tipoFertilizante": "Balanceado", "cantidad": "180g", "frecuencia": "Bimestral", "epocaAplicacion": "Crecimiento activo" },
        "poda": { "requiere": true, "tipo": "Formación" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Contenedor mediano" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "350-550ml", "frecuencia": "Cada 3 días", "observaciones": "Reducir riego en floración" },
        "fertilizacion": { "tipoFertilizante": "Rico en fósforo", "cantidad": "220g", "frecuencia": "Trimestral", "epocaAplicacion": "Antes de floración" },
        "poda": { "requiere": true, "tipo": "Formación" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Contenedor mediano" },
        "protecciones": ["Protección contra vientos fuertes"]
      }
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "400-600ml", "frecuencia": "Cada 3 días", "observaciones": "Mantener humedad constante" },
        "fertilizacion": { "tipoFertilizante": "Rico en nitrógeno", "cantidad": "250g", "frecuencia": "Trimestral", "epocaAplicacion": "Lluvias" },
        "poda": { "requiere": false },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Contenedor grande" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "300-500ml", "frecuencia": "Cada 3 días", "observaciones": "Riego regular para buen desarrollo" },
        "fertilizacion": { "tipoFertilizante": "Balanceado", "cantidad": "200g", "frecuencia": "Trimestral", "epocaAplicacion": "Crecimiento activo" },
        "poda": { "requiere": true, "tipo": "Formación" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Contenedor mediano" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "250-400ml", "frecuencia": "Cada 3 días", "observaciones": "Evitar encharcamientos" },
        "fertilizacion": { "tipoFertilizante": "Rico en potasio", "cantidad": "150g", "frecuencia": "Bimestral", "epocaAplicacion": "Todo el año" },
        "poda": { "requiere": true, "tipo": "Formación y fructificación" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Contenedor mediano" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "300-500ml", "frecuencia": "Cada 2 días", "observaciones": "Requiere alta humedad ambiental" },
        "fertilizacion": { "tipoFertilizante": "Orgánico", "cantidad": "200g", "frecuencia": "Bimestral", "epocaAplicacion": "Crecimiento activo" },
        "poda": { "requiere": false },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Contenedor mediano" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "400-600ml", "frecuencia": "Cada 3 días", "observaciones": "Sensible a sequías prolongadas" },
        "fertilizacion": { "tipoFertilizante": "Balanceado", "cantidad": "250g", "frecuencia": "Trimestral", "epocaAplicacion": "Crecimiento activo" },
        "poda": { "requiere": true, "tipo": "Formación" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Contenedor grande" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "350-550ml", "frecuencia": "Cada 4 días", "observaciones": "Tolerante a sequía una vez establecido" },
        "fertilizacion": { "tipoFertilizante": "Balanceado", "cantidad": "200g", "frecuencia": "Trimestral", "epocaAplicacion": "Crecimiento activo" },
        "poda": { "requiere": true, "tipo": "Formación" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Contenedor grande" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "300-500ml", "frecuencia": "Cada 3 días", "observaciones": "Sensible a exceso de agua" },
        "fertilizacion": { "tipoFertilizante": "Balanceado", "cantidad": "180g", "frecuencia": "Bimestral", "epocaAplicacion": "Crecimiento activo" },
        "poda": { "requiere": true, "tipo": "Formación" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Contenedor mediano" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "400-600ml", "frecuencia": "Cada 2 días", "observaciones": "Requiere alta humedad" },
        "fertilizacion": { "tipoFertilizante": "Nitrogenado", "cantidad": "150g", "frecuencia": "Bimestral", "epocaAplicacion": "Todo el año" },
        "poda": { "requiere": true, "tipo": "Frecuente" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Bolsa negra" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "250-400ml", "frecuencia": "Cada 3 días", "observaciones": "Tolerante a sequía" },
        "fertilizacion": { "tipoFertilizante": "Poco exigente", "cantidad": "120g", "frecuencia": "Semestral", "epocaAplicacion": "Crecimiento" },
        "poda": { "requiere": true, "tipo": "Formación" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Contenedor mediano" },
        "protecciones": ["Protección contra vientos"]
      }
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "300-450ml", "frecuencia": "Cada 3 días", "observaciones": "Muy adaptable" },
        "fertilizacion": { "tipoFertilizante": "Poco exigente", "cantidad": "100g", "frecuencia": "Semestral", "epocaAplicacion": "Crecimiento" },
        "poda": { "requiere": true, "tipo": "Contención" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Bolsa negra" },
        "protecciones": ["Resistente naturalmente"]
      }
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "200-350ml", "frecuencia": "Cada 5 días", "observaciones": "Muy resistente a sequía" },
        "fertilizacion": { "tipoFertilizante": "Poco exigente", "cantidad": "100g", "frecuencia": "Anual", "epocaAplicacion": "Lluvias" },
        "poda": { "requiere": false },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Bolsa negra" },
        "protecciones": ["Resistente naturalmente"]
      }
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "150-250ml", "frecuencia": "Cada 7 días", "observaciones": "Muy resistente a sequía" },
        "fertilizacion": { "tipoFertilizante": "Poco exigente", "cantidad": "80g", "frecuencia": "Anual", "epocaAplicacion": "Lluvias" },
        "poda": { "requiere": true, "tipo": "Formación" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Bolsa negra" },
        "protecciones": ["Manejar con cuidado por espinas"]
      }
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "250-400ml", "frecuencia": "Cada 4 días", "observaciones": "Riego moderado" },
        "fertilizacion": { "tipoFertilizante": "Balanceado", "cantidad": "120g", "frecuencia": "Bimestral", "epocaAplicacion": "Crecimiento" },
        "poda": { "requiere": true, "tipo": "Formación" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Contenedor mediano" },
        "protecciones": ["Protección contra vientos"]
      }
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "250-400ml", "frecuencia": "Cada 4 días", "observaciones": "Tolerante a sequía" },
        "fertilizacion": { "tipoFertilizante": "Calcio", "cantidad": "150g", "frecuencia": "Semestral", "epocaAplicacion": "Crecimiento" },
        "poda": { "requiere": false },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Contenedor mediano" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "300-450ml", "frecuencia": "Cada 3 días", "observaciones": "Tolerante a salinidad" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "250-400ml", "frecuencia": "Cada 3 días", "observaciones": "Muy adaptable" },
        "fertilizacion": { "tipoFertilizante": "Orgánico", "cantidad": "120g", "frecuencia": "Bimestral", "epocaAplicacion": "Todo el año" },
        "poda": { "requiere": true, "tipo": "Fructificación" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Contenedor mediano" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "300-500ml", "frecuencia": "Cada 4 días", "observaciones": "Crecimiento lento pero constante" },
        "fertilizacion": { "tipoFertilizante": "Balanceado", "cantidad": "200g", "frecuencia": "Trimestral", "epocaAplicacion": "Crecimiento" },
        "poda": { "requiere": false },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Contenedor grande" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "300-450ml", "frecuencia": "Cada 3 días", "observaciones": "Riego regular para buena producción" },
        "fertilizacion": { "tipoFertilizante": "Balanceado", "cantidad": "180g", "frecuencia": "Bimestral", "epocaAplicacion": "Crecimiento" },
        "poda": { "requiere": true, "tipo": "Formación" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Contenedor mediano" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "200-300ml", "frecuencia": "Cada 3 días", "observaciones": "Mantener humedad constante" },
        "fertilizacion": { "tipoFertilizante": "Orgánico", "cantidad": "100g", "frecuencia": "Bimestral", "epocaAplicacion": "Crecimiento" },
        "poda": { "requiere": true, "tipo": "Formación" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "400-600ml", "frecuencia": "Cada 2 días", "observaciones": "Requiere alta humedad ambiental" },
        "fertilizacion": { "tipoFertilizante": "Orgánico", "cantidad": "300g", "frecuencia": "Bimestral", "epocaAplicacion": "Todo el año" },
        "poda": { "requiere": true, "tipo": "Contención" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Contenedor grande" },
        "protecciones": ["Espacio amplio para desarrollo"]
      }
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "350-550ml", "frecuencia": "Cada 3 días", "observaciones": "Requiere humedad constante" },
        "fertilizacion": { "tipoFertilizante": "Balanceado", "cantidad": "200g", "frecuencia": "Trimestral", "epocaAplicacion": "Crecimiento" },
        "poda": { "requiere": false },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Contenedor grande" },
        "protecciones": ["Protección contra vientos"]
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "200-300ml", "frecuencia": "Cada 3 días", "observaciones": "Riego regular para buena floración" },
        "fertilizacion": { "tipoFertilizante": "Rico en fósforo", "cantidad": "80g", "frecuencia": "Bimestral", "epocaAplicacion": "Floración" },
        "poda": { "requiere": true, "tipo": "Frecuente" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Contenedor pequeño" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "100-200ml", "frecuencia": "Cada 2 días", "observaciones": "Mantener suelo húmedo" },
        "fertilizacion": { "tipoFertilizante": "Nitrogenado", "cantidad": "50g", "frecuencia": "Mensual", "epocaAplicacion": "Crecimiento" },
        "poda": { "requiere": true, "tipo": "Frecuente" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "150-250ml", "frecuencia": "Cada 3 días", "observaciones": "Riego regular para buen aroma" },
        "fertilizacion": { "tipoFertilizante": "Orgánico", "cantidad": "60g", "frecuencia": "Bimestral", "epocaAplicacion": "Crecimiento" },
        "poda": { "requiere": true, "tipo": "Frecuente" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Maceta pequeña" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "200-300ml", "frecuencia": "Cada 3 días", "observaciones": "Riego regular" },
        "fertilizacion": { "tipoFertilizante": "Balanceado", "cantidad": "80g", "frecuencia": "Bimestral", "epocaAplicacion": "Crecimiento" },
        "poda": { "requiere": true, "tipo": "Frecuente" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Contenedor pequeño" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "150-250ml", "frecuencia": "Cada 2 días", "observaciones": "Mantener humedad constante" },
        "fertilizacion": { "tipoFertilizante": "Orgánico", "cantidad": "60g", "frecuencia": "Mensual", "epocaAplicacion": "Crecimiento" },
        "poda": { "requiere": true, "tipo": "Frecuente" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Maceta pequeña" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "100-200ml", "frecuencia": "Cada 2 días", "observaciones": "Mantener suelo ligeramente húmedo" },
        "fertilizacion": { "tipoFertilizante": "Orgánico", "cantidad": "40g", "frecuencia": "Mensual", "epocaAplicacion": "Crecimiento" },
        "poda": { "requiere": true, "tipo": "Frecuente" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Maceta pequeña" },
    ...
    "cuidadosPorEdad": [
      {
        "etapa": "Plántula",
        "rangoEdadMeses": { "min": 1, "max": 6 },
        "riego": { "cantidadAgua": "300-400ml", "frecuencia": "Cada 2 días", "observaciones": "Requiere alta humedad" },
        "fertilizacion": { "tipoFertilizante": "Orgánico", "cantidad": "100g", "frecuencia": "Bimestral", "epocaAplicacion": "Crecimiento" },
        "poda": { "requiere": true, "tipo": "Frecuente" },
        "trasplante": { "requiere": true, "epocaRecomendada": "Inicio de lluvias", "tipoMaceta": "Contenedor mediano" },
        "protecciones": ["Protección contra sol directo"]
    ...
    cuidadosPorEdad: [
      {
        ...
        riego: { cantidadAgua: "300-600ml", frecuencia: "Cada 2 días", observaciones: "Requiere humedad constante" },
        fertilizacion: { tipoFertilizante: "Fertilizante completo", cantidad: "200g", frecuencia: "Trimestral", epocaAplicacion: "Crecimiento" },
        poda: { requiere: false },
